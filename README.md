...
| `:api-version`        | `nil`             | Stripe API version to be used. If not set, stripe-node will use the latest version at the time of release.                                                                                                                                        |
| `:stripe-account`        | `nil`             | For Connect, the Stripe account to use.                                                                                                                                        |
| `:max-network-retries` | 1                  | The amount of times a request should be [retried](#Network retries).                                                                                                                                                                              |
